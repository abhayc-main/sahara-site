      ...
      <div className="mx-auto">
        <div className="relative shadow-xl sm:overflow-hidden">
          ...
          <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
            <p className="relative left-0 right-0 mx-auto mt-5 max-w-xl text-center text-xl  font-semibold uppercase tracking-wide text-orange-600"></p>
            <h1 className="mt-1 text-center font-bold uppercase text-gray-900 sm:text-5xl sm:tracking-tight lg:text-7xl">
              <span className="block text-white">Sahara Mediterenean</span>
              <span className="block text-white">Kitchen</span>
            </h1>
